...
from persepsi.deep_sort.deep.reid.torchreid.utils import FeatureExtractor
from persepsi.deep_sort.deep.reid.torchreid.utils.tools import download_url
...
class DeepSort(object):
    def __init__(self, model, device, max_dist=0.2, max_iou_distance=0.7, max_age=70, n_init=3, nn_budget=100):
        if is_model_in_factory(model):
            ...
            model_path = os.path.abspath(__file__+"/../deep/checkpoint/" + model + ".pth")
