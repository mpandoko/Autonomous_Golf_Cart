...
from persepsi.yolov5.utils.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
from persepsi.yolov5.utils.general import (DATASETS_DIR, LOGGER, NUM_THREADS, check_dataset, check_requirements, check_yaml, clean_str,
                           segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywhn)
from persepsi.yolov5.utils.torch_utils import torch_distributed_zero_first
...
def extract_boxes(path=DATASETS_DIR / 'coco128'):  # from persepsi.yolov5.utils.datasets import *; extract_boxes()
...
def autosplit(path=DATASETS_DIR / 'coco128/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from persepsi.yolov5.utils.datasets import *; autosplit()
    Arguments
...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False, profile=False, hub=False):
    ...
    Usage1: from persepsi.yolov5.utils.datasets import *; dataset_stats('coco128.yaml', autodownload=True)
    Usage2: from persepsi.yolov5.utils.datasets import *; dataset_stats('path/to/coco128_with_yaml.zip')
    Arguments
