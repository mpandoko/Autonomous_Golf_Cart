...
from persepsi.yolov5.utils.downloads import gsutil_getsize
from persepsi.yolov5.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from persepsi.yolov5.utils.general import *; strip_optimizer()
