...
def callback(msg_nav):
    ...
    state['x'] = msg_nav.pose.pose.position.x
    state['y'] = msg_nav.pose.pose.position.y
    state['v'] = np.sqrt(msg_nav.twist.twist.linear.x**2 + msg_nav.twist.twist.linear.y**2)
    state['yaw'] = atan2(2 * (msg_nav.pose.pose.orientation.w * msg_nav.pose.pose.orientation.z + msg_nav.pose.pose.orientation.x * msg_nav.pose.pose.orientation.y), 1 - 2 * (msg_nav.pose.pose.orientation.y**2 + msg_nav.pose.pose.orientation.z**2))
